...
func init() {
	...
	utilruntime.Must(litmuschaosiov1alpha1.AddToScheme(scheme))
	utilruntime.Must(operatorScheme.AddToScheme(scheme))
...
func main() {
	...
	if err = (&controllers.ChaosScheduleReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("chaos-scheduler"),
